...
def get_book_storage(request: Request) -> BooksStorage:
    return request.app.state.books_storage


GetBooksStorage = Annotated[BooksStorage, Depends(get_book_storage)]
...
def prefetch_book(slug: str, storage: GetBooksStorage) -> Book:
